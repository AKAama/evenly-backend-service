...
class ExpenseResponse(ExpenseBase):
    ...
    created_by: UUID
    status: str
    # Partial refund; net spend is total_amount - refund_amount.
...
class ExpenseRefundRequest(BaseModel):
    """Record or clear a partial refund against an existing expense."""
